...
import com.kxs109.commonlib.config.utils.ext.LogExtKt;
 ...
 */
public class KxsLinearLayoutManager extends RecyclerView.LayoutManager implements
     ...
     * helps {@link KxsLinearLayoutManager} make those decisions.
     */
     ...
     */
    public KxsLinearLayoutManager(Context context) {
     ...
     */
    public KxsLinearLayoutManager(Context context, @RecyclerView.Orientation int orientation,
     ...
     */
    public KxsLinearLayoutManager(Context context, AttributeSet attrs, int defStyleAttr,
                                  int defStyleRes) {
    ...
    /**
     * Sets the orientation of the layout. {@link KxsLinearLayoutManager}
     ...
     *
     * <p>By default, {@link KxsLinearLayoutManager} lays out 1 extra page
     ...
     * KxsLinearLayoutManager} and stores the result in {@code extraLayoutSpace}. {@code
    ...
    protected void calculateExtraLayoutSpace(@NonNull RecyclerView.State state,
        ...
        LogExtKt.logE("kxs109", "x>>"+extraLayoutSpace[0]+"=======y>>"+extraLayoutSpace[1]);
    }
     ...
     * @see KxsLinearLayoutManager.LayoutState#mLayoutDirection
     */
     ...
     * independent from the rest of the {@link KxsLinearLayoutManager}
